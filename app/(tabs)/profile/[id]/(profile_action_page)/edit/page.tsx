    ...
    <div className="p-5  h-screen mt-4 ">
      <div className="bg-white  rounded-lg shadow">
        <form action={action} className="flex flex-col gap-5 p-5 items-center">
          <div className="flex w-full px-10 py-2 items-center gap-8">
            <label
              htmlFor="photo"
              className="size-16 border-1  flex items-center justify-center flex-col text-black border-neutral-300 rounded-full border-dashed cursor-pointer bg-center bg-cover bg-red-200"
              style={{
