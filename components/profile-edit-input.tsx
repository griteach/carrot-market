  ...
  return (
    <div className="grid grid-cols-5 w-full gap-3   px-10">
      ...
      <div className="flex flex-col gap-2 col-span-3">
        <input
          className="bg-transparent rounded-md w-full h-10   text-black  focus:outline-none ring-2 focus:ring-4 ring-neutral-200 focus:ring-orange-500 border-none placeholder:text-neutral-400 transition"
          name={name}
          {...rest}
        />
